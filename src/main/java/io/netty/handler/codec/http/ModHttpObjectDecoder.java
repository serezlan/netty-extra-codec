 ...
 */
public abstract class ModHttpObjectDecoder extends ByteToMessageDecoder {
    public static final int DEFAULT_MAX_INITIAL_LINE_LENGTH = 4096;
    public static final int DEFAULT_MAX_HEADER_SIZE = 8192;
    public static final boolean DEFAULT_CHUNKED_SUPPORTED = true;
  public static final boolean DEFAULT_IGNORE_TRANSFER_ENCODING =false;
  ...
  private final boolean ignoreTransferEncoding;
    ...
    /**
     * The internal state of {@link ModHttpObjectDecoder}.
     ...
     */
    protected ModHttpObjectDecoder() {
      this(DEFAULT_MAX_INITIAL_LINE_LENGTH, DEFAULT_MAX_HEADER_SIZE, DEFAULT_MAX_CHUNK_SIZE, DEFAULT_CHUNKED_SUPPORTED, DEFAULT_VALIDATE_HEADERS, DEFAULT_INITIAL_BUFFER_SIZE, DEFAULT_ALLOW_DUPLICATE_CONTENT_LENGTHS, DEFAULT_IGNORE_TRANSFER_ENCODING);
    }

  protected ModHttpObjectDecoder (boolean ignoreTransferEncoding) {
    this(DEFAULT_MAX_INITIAL_LINE_LENGTH, DEFAULT_MAX_HEADER_SIZE, DEFAULT_MAX_CHUNK_SIZE, DEFAULT_CHUNKED_SUPPORTED, DEFAULT_VALIDATE_HEADERS, DEFAULT_INITIAL_BUFFER_SIZE, DEFAULT_ALLOW_DUPLICATE_CONTENT_LENGTHS, ignoreTransferEncoding);
  }

    protected ModHttpObjectDecoder(
            int maxInitialLineLength, int maxHeaderSize, int maxChunkSize,
            boolean chunkedSupported, boolean validateHeaders, int initialBufferSize,
            boolean allowDuplicateContentLengths, boolean ignoreTransferEncoding) {
	...
	this.ignoreTransferEncoding = ignoreTransferEncoding;
    }
    ...
    private State readHeaders(ByteBuf buffer) {
	  ...
	  if (!contentLengthFields.isEmpty() && contentLength() >=0 && message.protocolVersion() == HttpVersion.HTTP_1_1) {
                handleTransferEncodingChunkedWithContentLength(message);
            }

	  if (ignoreTransferEncoding) {
