 ...
 * </table>
 */
public class ModHttpRequestDecoder extends ModHttpObjectDecoder {
     ...
     */
    public ModHttpRequestDecoder() {
    }

  public ModHttpRequestDecoder(boolean ignoreTransferEncoding) {
    super (ignoreTransferEncoding);
    }
  ...
  @Override
  protected void handleTransferEncodingChunkedWithContentLength (HttpMessage msg) {
  }
}
