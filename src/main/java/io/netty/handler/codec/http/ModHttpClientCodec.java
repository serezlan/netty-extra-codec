 ...
 * @see HttpServerCodec
 */
public final class ModHttpClientCodec extends CombinedChannelDuplexHandler<HttpResponseDecoder, ModHttpRequestEncoder>
     ...
     */
    public ModHttpClientCodec(int maxInitialLineLength, int maxHeaderSize, int maxChunkSize) {
    ...
    private final class Encoder extends ModHttpRequestEncoder {
