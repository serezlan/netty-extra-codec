 ...
 */
public abstract class ModHttpObjectEncoder<H extends HttpMessage> extends MessageToMessageEncoder<Object> {
    ...
    protected void encode(ChannelHandlerContext ctx, Object msg, List<Object> out) throws Exception {
        ...
        if (msg instanceof HttpMessage) {
            ...
            state = isContentAlwaysEmpty(m) ? ST_CONTENT_ALWAYS_EMPTY : ST_CONTENT_NON_CHUNK;
